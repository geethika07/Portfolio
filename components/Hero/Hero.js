    ...
    >
      ...
      <div className="flex flex-col pt-40 md:pt-0 select-none">
        ...
        <h1 className={`${styles.heroName} text-white text-6xl font-semibold`}>
          <span className={`relative ${styles.emphasize} seq`}>Geethika</span>
          <span className="seq"> Vadlamudi</span>
        </h1>
        <p>
          <span
            ref={typedEl}
        ...
        <div className="flex flex-row gap-6 seq pt-4" >
          <Button href={`#${MENULINKS[6].ref}`} classes="link" type="primary">
            Let&apos;s Talk
          </Button>
